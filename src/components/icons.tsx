// Icônes SVG du header et de la barre d'outils de la page principale (extraites de
// page.tsx). Composants purs, sans état. Chaque autre composant (HeaderMenu,
// SettingsButton…) garde ses propres icônes locales ; celles-ci ne servent qu'à page.tsx.
...
// Icône « corbeille » (effacer une entrée d'historique)
...
/** Bulle de discussion — le fil du club. */
