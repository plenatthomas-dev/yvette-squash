...
export default function InterclubLive({
  ...
  const load = useCallback(async () => {
    try {
      ...
      // lecture. Le prochain passage réessaiera.
      setFixtures((f) => f ?? []);
    }
  }, [onExpired]);
  ...
  useEffect(() => {
    ...
    // Au retour sur l'onglet on rafraîchit tout de suite, en cours ou non : c'est le geste
    // qui exprime « montre-moi où ça en est ».
    const onFocus = () => {
